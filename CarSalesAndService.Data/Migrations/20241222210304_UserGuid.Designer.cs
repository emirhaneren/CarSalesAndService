...
namespace CarSalesAndService.Data.Migrations
{
    ...
    [Migration("20241222210304_UserGuid")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Kullanici", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adi = "Admin",
                            AktifMi = true,
                            EklenmeTarihi = new DateTime(2024, 12, 23, 0, 3, 3, 82, DateTimeKind.Local).AddTicks(4117),
                            ...
                            Soyadi = "admin",
                            Telefon = "19031903",
                            UserGuid = new Guid("ec6a30b4-c0e8-461d-b6cd-3978f1a438f8")
                        });
                });

            modelBuilder.Entity("CarSalesAndService.Entities.Marka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Musteri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Satis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Servis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Arac", b =>
                {
                    b.HasOne("CarSalesAndService.Entities.Marka", "Marka")
                        .WithMany()
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Kullanici", b =>
                {
                    b.HasOne("CarSalesAndService.Entities.Rol", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Musteri", b =>
                {
                    b.HasOne("CarSalesAndService.Entities.Arac", "Arac")
                        .WithMany()
            ...
            modelBuilder.Entity("CarSalesAndService.Entities.Satis", b =>
                {
                    ...
                    b.HasOne("CarSalesAndService.Entities.Musteri", "Musteri")
                        .WithMany()
